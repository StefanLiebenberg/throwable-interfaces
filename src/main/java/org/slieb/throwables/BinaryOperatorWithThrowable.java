...
public interface BinaryOperatorWithThrowable<T, E extends Throwable> extends BinaryOperator<T> {
     ...
     * @return the cast interface
     */
    static <T, E extends Throwable> BinaryOperator<T> aBinaryOperatorThatUnsafelyThrowsUnchecked(final BinaryOperatorWithThrowable<T, E> binaryoperatorwiththrowable) throws E {
     ...
     */
    default BinaryOperator<T> thatUnsafelyThrowsUnchecked() throws E {
      return (final T v1, final T v2) -> {
        try {
          return applyWithThrowable(v1, v2);
        } catch(final Throwable throwable) {
