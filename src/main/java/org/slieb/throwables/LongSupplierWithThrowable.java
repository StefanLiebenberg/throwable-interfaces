...
public interface LongSupplierWithThrowable<E extends Throwable> extends java.util.function.LongSupplier {
    ...
    default LongSupplierWithThrowable<E> withLogging(java.util.logging.Logger logger, java.util.logging.Level level, String message) {
        return () -> {
            try {
                return getAsLongWithThrowable();
            } catch (final Throwable throwable) {
    ...
    default LongSupplierWithThrowable<E> withLogging(java.util.logging.Logger logger) {
        return withLogging(logger, java.util.logging.Level.WARNING, "Exception in LongSupplierWithThrowable");
    }
